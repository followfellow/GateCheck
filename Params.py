...
class ReadParameters():
    def __init__(self):
        ...
        self.swing_code_var=tk.StringVar()
        self.three_code_var=tk.StringVar()
        self.gate_mode_var = tk.StringVar()
        self.local_card_var = tk.StringVar()
        ...
        self.light_default_var = tk.StringVar()
    ...
    def read_params(self, par):
        ...
        self.local_card_var.set(par.dict['GateForm']['local_card'])
        self.pause_var.set(par.dict['GateForm']['pause'])
        ...
        self.swing_code_var.set(par.dict['GateForm']['swing_code'])
        self.three_code_var.set(par.dict['GateForm']['three_code'])
        self.gate_mode_var.set(par.dict['GateMode']['gate_mode'])
        self.ticket_mode_var.set(par.dict['GateMode']['ticket_mode'])
        self.quality_var.set(par.dict['GateMode']['quality'])
        ...
        self.beep_var.set(par.dict['Reader']['beep'])
